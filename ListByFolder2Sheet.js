function listAllFilesToSheet() {
  ...
  var primaryFolderId = "13bxBaRECe8URovIbifvlH7oV_vT2B8eo"; // Replace with your primary folder's ID
  var primaryFolder = DriveApp.getFolderById(primaryFolderId);

  // Create a new Google Sheet to store the file listings
  var spreadsheet = SpreadsheetApp.create("Rabia 2024_2025 Recordings By Subject_Noor Ul Anwar");
